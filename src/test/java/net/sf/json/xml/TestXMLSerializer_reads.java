...
public class TestXMLSerializer_reads extends TestCase {
    ...
    public void testNullObjectArray_noTypeHintsCompatibility() {
        String xml =
                "<a><e json_class=\"object\" json_null=\"true\"/><e json_class=\"object\" json_null=\"true\"/></a>";
    ...
    public void testReadMultiBooleanArray_withoutDefaultType() {
        String xml =
                "<a><e type=\"boolean\">true</e><e type=\"boolean\">false</e><e class=\"array\"><e type=\"boolean\">false</e><e type=\"boolean\">true</e></e></a>";
        JSON actual = xmlSerializer.read(xml);
        JSON expected = JSONArray.fromObject("[true,false,[false,true]]");
        Assertions.assertEquals(expected, actual);
    }
    ...
    public void testReadMultiFloatArray_withDefaultType() {
        String xml =
                "<a type=\"float\"><e>1.1</e><e>2.2</e><e>3.3</e><e class=\"array\"><e>1.1</e><e>2.2</e><e>3.3</e></e></a>";
        JSON actual = xmlSerializer.read(xml);
    ...
    public void testReadMultiFloatArray_withoutDefaultType() {
        String xml =
                "<a><e type=\"float\">1.1</e><e type=\"float\">2.2</e><e type=\"float\">3.3</e><e class=\"array\"><e type=\"float\">1.1</e><e type=\"float\">2.2</e><e type=\"float\">3.3</e></e></a>";
        JSON actual = xmlSerializer.read(xml);
        JSON expected = JSONArray.fromObject("[1.1,2.2,3.3,[1.1,2.2,3.3]]");
        Assertions.assertEquals(expected, actual);
    }
    ...
    public void testReadMultiIntegerArray_withoutDefaultType() {
        String xml =
                "<a><e type=\"integer\">1</e><e type=\"integer\">2</e><e type=\"integer\">3</e><e class=\"array\"><e type=\"integer\">1</e><e type=\"integer\">2</e><e type=\"integer\">3</e></e></a>";
        JSON actual = xmlSerializer.read(xml);
        JSON expected = JSONArray.fromObject("[1,2,3,[1,2,3]]");
        Assertions.assertEquals(expected, actual);
    }
    ...
    public void testReadMultiMixedArray_withDefaultType() {
        String xml =
                "<a type=\"string\"><e type=\"boolean\">true</e><e type=\"number\">2.2</e><e>3</e><e class=\"array\"><e type=\"boolean\">true</e><e type=\"number\">2.2</e><e>3</e></e></a>";
        JSON actual = xmlSerializer.read(xml);
    ...
    public void testReadMultiMixedArray_withoutDefaultType() {
        String xml =
                "<a><e type=\"boolean\">true</e><e type=\"number\">2.2</e><e type=\"string\">3</e><e class=\"array\"><e type=\"boolean\">true</e><e type=\"number\">2.2</e><e type=\"string\">3</e></e></a>";
        JSON actual = xmlSerializer.read(xml);
        JSON expected = JSONArray.fromObject("[true,2.2,\"3\",[true,2.2,\"3\"]]");
        Assertions.assertEquals(expected, actual);
    }
    ...
    public void testReadMultiNumberArray_withDefaultType() {
        String xml =
                "<a type=\"number\"><e>1.1</e><e>2.2</e><e>3</e><e class=\"array\"><e>1.1</e><e>2.2</e><e>3</e></e></a>";
        JSON actual = xmlSerializer.read(xml);
    ...
    public void testReadMultiNumberArray_withoutDefaultType() {
        String xml =
                "<a><e type=\"number\">1.1</e><e type=\"number\">2.2</e><e type=\"number\">3</e><e class=\"array\"><e type=\"number\">1.1</e><e type=\"number\">2.2</e><e type=\"number\">3</e></e></a>";
        JSON actual = xmlSerializer.read(xml);
        JSON expected = JSONArray.fromObject("[1.1,2.2,3,[1.1,2.2,3]]");
        Assertions.assertEquals(expected, actual);
    }
    ...
    public void testReadMultiStringArray_withDefaultType() {
        String xml =
                "<a type=\"string\"><e>1.1</e><e>2.2</e><e>3</e><e class=\"array\"><e>1.1</e><e>2.2</e><e>3</e></e></a>";
        JSON actual = xmlSerializer.read(xml);
        JSON expected = JSONArray.fromObject("[\"1.1\",\"2.2\",\"3\",[\"1.1\",\"2.2\",\"3\"]]");
        Assertions.assertEquals(expected, actual);
    }
    ...
    public void testReadMultiStringArray_withoutDefaultType() {
        String xml =
                "<a><e type=\"string\">1.1</e><e type=\"string\">2.2</e><e type=\"string\">3</e><e class=\"array\"><e type=\"string\">1.1</e><e type=\"string\">2.2</e><e type=\"string\">3</e></e></a>";
        JSON actual = xmlSerializer.read(xml);
        JSON expected = JSONArray.fromObject("[\"1.1\",\"2.2\",\"3\",[\"1.1\",\"2.2\",\"3\"]]");
        Assertions.assertEquals(expected, actual);
    }
    ...
    public void testReadObject_withAttributes_noTypeHintsEnabled() {
        ...
        JSON actual = xmlSerializer.read(xml);
        JSON expected = new JSONObject()
                .element("@class", "Java.class")
                .element("@type", "object")
                .element("@string", "json")
                .element("@number", "1");
        Assertions.assertEquals(expected, actual);
    ...
    public void testReadObject_withText_2() {
        ...
        JSON expected = new JSONObject()
                .element("string", "json")
                .element("#text", new JSONArray().element("first").element("second"));
        Assertions.assertEquals(expected, actual);
    }
    ...
    public void testReadSimpleObject_withDefaultType() {
        String xml =
                "<o type=\"number\"><bool type=\"boolean\">true</bool><int>1</int><double>2.2</double><string type=\"string\">json</string><numbers class=\"array\"><e>4.44</e><e>5</e></numbers></o>";
        JSONObject actual = (JSONObject) xmlSerializer.read(xml);
    ...
    public void testReadWithNamespace_array() {
        String xml =
                "<a xmlns=\"http://json.org/json/1.0\" xmlns:ns=\"http://www.w3.org/2001/XMLSchema-instance\"><ns:string>json</ns:string><ns:string>1</ns:string></a>";
        JSON actual = xmlSerializer.read(xml);
        JSONObject expected = new JSONObject()
                .element("@xmlns", "http://json.org/json/1.0")
    ...
    public void testReadWithNamespace_object() {
        String xml =
                "<o xmlns=\"http://json.org/json/1.0\" xmlns:ns=\"http://www.w3.org/2001/XMLSchema-instance\"><ns:string>json</ns:string><ns:number>1</ns:number></o>";
        JSON actual = xmlSerializer.read(xml);
        JSONObject expected = new JSONObject()
                .element("@xmlns", "http://json.org/json/1.0")
                .element("@xmlns:ns", "http://www.w3.org/2001/XMLSchema-instance")
