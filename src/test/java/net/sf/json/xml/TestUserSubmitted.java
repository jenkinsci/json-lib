...
public class TestUserSubmitted extends TestCase {
    ...
    public void testReadFromXMLToJSON_1735732() throws Exception {
        ...
        JSONObject expected = new JSONObject()
                .element("@xmlns:ns2", "http://schemas.foo.com/HelloWorld")
                .element("item", new JSONObject().element("age", "2 5").element("name", "emp1"))
                .accumulate("item", new JSONObject().element("age", "2").element("name", "emp2"));
    ...
    public void testReadFromXMLToJSON_1739066() throws Exception {
        ...
        JSONObject expected = new JSONObject()
                .element("Address", "http://localhost:0/te stToString")
                .element("@xmlns", "http://www.w3.org/2005/08/addressing")
                .element(
                        "Metadata",
                        new JSONObject()
                                .element("@xmlns:wsa-wsdl", "http://www.w3.org/2006/01/wsdl-instance")
                                .element("@wsa-wsdl:wsdlLocation", "file:///b.wsdl")
                                .element(
                                        "ns3:InterfaceName",
                                        new JSONObject()
                                                .element("@xmlns:tns", "http://com.iona.cxf/GreetMe")
                                                .element("@xmlns:ns3", "http://www.w3.org/2005/02/addressing/wsdl")
                                                .element("#text", "tns:GreetMePortType"))
                                .element(
                                        "ns3:ServiceName",
                                        new JSONObject()
                                                .element("@EndpointName", "GreetMePort")
                                                .element("@xmlns:tns", "http://com.iona.cxf/GreetMe")
                                                .element("@xmlns:ns3", "http://www.w3.org/2005/02/addressing/wsdl")
    ...
    public void testXMLRoundtrip() {
        String json =
                "{\"entries\": [ { \"credits\": \"p1\", \"id\": 1, \"status\": true, \"text\": \"1\" }, { \"credits\": \"p2\", \"id\": 2, \"status\": true, \"text\": \"2\" } ]}";
    ...
    public void testXMLWithArraySingleElement() {
        String testXML = "    <rate>" + "      <rateBreakdown>\n"
                + "        <rate>\n"
                + "          <date>\n"
                + "            <day>15</day>\n"
                + "            <month>1</month>\n"
        ...
        JSON expected = JSONSerializer.toJSON(
                "{\"rate\":{\"rateBreakdown\":[{\"amount\":\"109.74\",\"date\":{\"month\":\"1\",\"day\":\"15\",\"year\":\"2007\"}}],\"totalAmount\":\"219.48\"}}");
